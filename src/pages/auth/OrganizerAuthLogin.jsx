    ...
    <div className="min-h-screen flex bg-zinc-950">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative flex-col overflow-hidden">
        ...
        <div className="relative z-10 p-10 flex flex-col h-full">
          ...
          <h2 className="text-4xl font-black text-white leading-tight mb-3">Build tournaments. Manage operations. Monetize events.</h2>
          <p className="text-zinc-400 text-base leading-relaxed mb-6">Professional tournament infrastructure for MENA organizers.</p>
