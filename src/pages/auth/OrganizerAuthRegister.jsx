  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 py-12">
      ...
      <div className="w-full max-w-md relative z-10">
        <Link to="/auth/organizer/login" className="inline-flex items-center gap-2 text-gray-400 hover:text-indigo-400 mb-6 transition-colors">
        ...
        <FloatingPanel className="p-8">
          ...
          <div className="mt-5 text-center space-y-2">
            <p className="text-gray-500 text-sm">
              Already registered?{' '}
              <Link to="/auth/organizer/login" className="text-indigo-400 hover:text-indigo-300 transition-colors">Sign in</Link>
            </p>
