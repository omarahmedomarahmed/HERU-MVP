...
import { Briefcase, Eye, EyeOff, LogIn, AlertTriangle } from 'lucide-react';
      ...
      <div className="w-full max-w-md">
        ...
        <FloatingPanel className="p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button type="submit" disabled={loading} className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white font-medium transition-colors disabled:opacity-50">
          ...
          <div className="mt-6 text-center space-y-2">
            <p className="text-gray-500 text-sm">No account? <Link to="/auth/provider/register" className="text-emerald-400 hover:text-emerald-300">Register as provider</Link></p>
