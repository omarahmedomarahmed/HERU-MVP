...
const CATEGORY_COLORS = {
  ...
  EventVendor:    'bg-pink-500/20 text-pink-300 border-pink-500/30',
  TournamentMgmt: 'bg-teal-500/20 text-teal-300 border-teal-500/30',
  Influencer:     'bg-rose-500/20 text-rose-300 border-rose-500/30',
  Branding:       'bg-indigo-500/20 text-indigo-300 border-indigo-500/30',
};
